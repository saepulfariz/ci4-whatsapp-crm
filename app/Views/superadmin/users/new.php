                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= ($error = validation_show_error('username')) ? 'border-danger' : ((old('username')) ? 'border-success' : ''); ?>" id="username" name="username" placeholder="Username" value="<?= old('username'); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control <?= ($error = validation_show_error('email')) ? 'border-danger' : ((old('email')) ? 'border-success' : ''); ?>" id="email" name="email" placeholder="email" value="<?= old('email'); ?>">
                            </div>
                            <?= ($error) ? '<div class="error text-danger mb-2" style="margin-top: -15px">' . $error . '</div>' : ''; ?>
