                    ...
                    <form action="<?= base_url($link); ?>" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="keyword" id="keyword" class="form-control" value="<?= old('keyword'); ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="match1" name="is_exact_match" value="1" checked>
                                    <label for="match1" class="custom-control-label"><?= temp_lang('auto_replies.exact_match'); ?></label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="match0" name="is_exact_match" value="0">
